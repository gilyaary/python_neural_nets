...
class Node:
    def __init__(self, name, layerIndex):
        ...
        if self.layerIndex < 0:
            self.activationFunction = ReLuActivation()
        else:
    ...
    def fwd(self):
        ...
        if self.lastNode == True:
                ...
                self.outValue = self.actualLabel * np.log(inputValues+0.00000000001) + (1-self.actualLabel) * (np.log(1-inputValues + 0.00000000001))
    ...
    def back(self):
        ...
        if self.lastNode == True:
            ...
            inputValues = self.ins[0].outValue
            slope = (self.actualLabel-inputValues) / (inputValues * (-inputValues+1) + 0.00000000001)
        ...
        if self.lastNode == False and self.layerIndex > 0:
            ...
            #da/dz
            activationGradient = self.activationFunction.getGradient(self.z) 
...
class ThresholdActivation:
    ...
    def getGradient(self, z):
        #this is da/dz
        isPositive = z > 0
        activationGradient = isPositive * 1 
        return activationGradient
...
class ReLuActivation:
    ...
    def apply(self, z):
        isPositive = z > 0
        return isPositive * z + 0.00000001
